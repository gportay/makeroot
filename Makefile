...
tests: machine-tests x86_64-tests aarch64-tests debarchs-tests
	bash makeroot $(MAKEROOTFLAGS) --distro alpinelinux test-alpinelinux
	bash makeroot $(MAKEROOTFLAGS) --distro archlinux   test-archlinux
...
machine-tests:
	bash $(shell uname -m)-makeroot $(MAKEROOTFLAGS) --distro alpinelinux test-alpinelinux-$(shell uname -m)
	bash $(shell uname -m)-makeroot $(MAKEROOTFLAGS) --distro archlinux   test-archlinux-$(shell uname -m)
...
.SILENT: x86_64-tests
x86_64-tests:
	bash x86_64-makeroot $(MAKEROOTFLAGS) --distro alpinelinux test-alpinelinux-x86_64
	bash x86_64-makeroot $(MAKEROOTFLAGS) --distro archlinux   test-archlinux-x86_64
...
aarch64-tests:
	bash aarch64-makeroot $(MAKEROOTFLAGS) --distro alpinelinux test-alpinelinux-aarch64
	bash aarch64-makeroot $(MAKEROOTFLAGS) --distro archlinux   test-archlinux-aarch64
